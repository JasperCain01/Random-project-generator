...
themes you care about (health, finance, politics, …).
...
data/questions.yaml    20 question archetypes with {dataset} placeholders
data/challenges.yaml   20 dataset-independent challenges
        │
...
to run a PCA on a two-column table. The current registry yields **~5,000
